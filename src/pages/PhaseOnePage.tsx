        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="bg-slate-800 rounded-xl p-6 text-white mb-8">
              ...
              <p className="text-slate-200 leading-relaxed mb-4">
                A few weeks later, I was given another impromptu question: <em>"When is it okay to break the rules?"</em> 
          ...
          >
            ...
            <div className="prose prose-slate prose-lg max-w-none mb-6" style={{ lineHeight: '1.9' }}>
              <p>
                I have included three recordings below that document my progression. The first is almost 
                painful to watch now because it shows all the habits I described above. The second is 
                the actual mock interview where I applied my new techniques. The third is my peer's 
                recording, which taught me an unexpected lesson about nonverbal communication.
              </p>
            </div>
            ...
            <div className="space-y-8">
              {/* Pre-Mock Practice */}
              <div>
                <h3 className="text-lg font-semibold text-slate-800 mb-3">1. Pre-Mock Practice Recording</h3>
              ...
              {/* Actual Mock Interview */}
              <div>
                <h3 className="text-lg font-semibold text-slate-800 mb-3">2. Actual Mock Interview</h3>
                <p className="text-slate-600 mb-4 leading-relaxed">
              ...
              {/* Peer Interview */}
              <div>
                <h3 className="text-lg font-semibold text-slate-800 mb-3">3. Peer Interview (Shirley)</h3>
                <p className="text-slate-600 mb-4 leading-relaxed">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="prose prose-slate prose-lg max-w-none" style={{ lineHeight: '1.9' }}>
                <h3>Processing This Feedback</h3>
                <p>
              ...
              <FeedbackBlock type="action" title="How I Applied This">
                <p className="mb-0">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <h2 className="text-2xl font-bold text-slate-900">
                What I Learned from Watching Shirley
              </h2>
              <CompetencyBadge label="Interpersonal Competency" variant="interpersonal" />
            </div>
            ...
            <div className="prose prose-slate prose-lg max-w-none mt-6" style={{ lineHeight: '1.9' }}>
              <p>
